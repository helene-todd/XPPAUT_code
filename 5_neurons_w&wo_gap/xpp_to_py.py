...
with open('no_synchronization.dat', newline='') as file:
...
fig.suptitle('Network of 5 electrically coupled neurons, $\\beta=0.1$ and $\gamma=0$', size=12)
ax[0].legend(bbox_to_anchor=(1.0525, 1))
ax[1].legend(bbox_to_anchor=(1, 1))

plt.savefig('5_neurons_without_gap.svg')
#plt.show()
