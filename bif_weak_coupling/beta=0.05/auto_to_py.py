...
plt.axvspan(1, 1.84879, facecolor='0.2', alpha=0.1)
...
plt.title('Bifurcation diagram for two weakly coupled neurons, $\\beta =0.05$', fontsize=11)
...
plt.legend(by_label.values(), by_label.keys(), loc='upper right', bbox_to_anchor=(1, 0.95), facecolor='white', framealpha=1)

plt.savefig('bif_diagram_beta=0.05.svg')
#plt.show()
