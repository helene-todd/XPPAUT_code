...
plt.axvspan(1, 1.34431, facecolor='0.2', alpha=0.1)
...
plt.title('Bifurcation diagram for two weakly coupled neurons, $\\beta =0.15$', fontsize=11)
...
plt.savefig('bif_diagram_beta=0.15.svg')
#plt.show()
